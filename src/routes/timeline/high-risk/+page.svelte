		...
		<div class="flex flex-col gap-6" style="width: 75vw">
			...
			<StructuredList>
				...
				<StructuredListBody>
					...
					<StructuredListRow>
						...
						<StructuredListCell>High Risk</StructuredListCell>
					</StructuredListRow>
					<StructuredListRow>
			...
			<div class="flex flex-row flex-wrap gap-6 justify-around items-center min-h-[50vh]">
				...
				<div style="max-width: 250px">
					<FormGroup>
						<Button class="day" on:click={() => store.add(-5, 'day')}>Prev. Appointment</Button>
						<Spacer height="6px"/>
						<p class="text-center">
							{dayjs($store?.selected).format('MM/DD/YYYY')}
						</p>
						<Spacer height="6px"/>
						<Button class="day" on:click={() => store.add(5, 'day')}>Next Appointment</Button>
						<Spacer height="6px"/>
			...
			<OrderedList>
				...
				<ListItem>Have more frequent check-ups due to high risk of miscarriage.</ListItem>
			</OrderedList>
