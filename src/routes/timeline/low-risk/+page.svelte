		...
		<div class="flex flex-col gap-6" style="width: 75vw">
			...
			<StructuredList>
				...
				<StructuredListBody>
					...
					<StructuredListRow>
						...
						<StructuredListCell>Low Risk</StructuredListCell>
					</StructuredListRow>
					<StructuredListRow>
			...
			<div class="flex flex-row flex-wrap gap-6 justify-around items-center min-h-[50vh]">
				...
				<div style="max-width: 250px">
					<FormGroup>
						<Button class="day" on:click={() => store.add(-1, 'month')}>Prev. Appointment</Button>
						<Spacer height="6px"/>
						<p class="text-center">
							{dayjs($store?.selected).format('MM/DD/YYYY')}
						</p>
						<Spacer height="6px"/>
						<Button class="day" on:click={() => store.add(1, 'month')}>Next Appointment</Button>
						<Spacer height="6px"/>
			...
			<OrderedList>
				<ListItem>Seek professional help from doctor with schedule for moderate check-ups
				</ListItem>
				<ListItem>Seek a diet management plan from your healthcare provider.</ListItem>
				...
				<ListItem>Have moderately amount of check-ups to ensure no miscarriage occurs.</ListItem>
			</OrderedList>
			...
			<OrderedList>
				...
				<ListItem>You will require more energy as your baby grows.</ListItem>
